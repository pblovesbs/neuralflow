        ...
        try:
            ...
            if current_hash != _LAST_HASH:
                ...
                for f in _FILTERS:
                    ...
                    if match:
                        await broadcast_log(manager, "system", f"📋 Clipboard matched filter for workflow {f['workflow_id']}", "INFO")
                        ...
                        try:
                            wf_path = os.path.expanduser(f"~/.neuralflow/workflows/{f['workflow_id']}.json")
