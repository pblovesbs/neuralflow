...
def generate_use_case_dag(use_case_id: str, config: Dict[str, Any]) -> dict:
        ...
        nodes.append(
            {
                ...
                "data": {
                    ...
                    "target_path": config.get("source_path", ""),
                },
            }
        )
        nodes.append(
            ...
            nodes.append(
                {
                    ...
                    "data": {
                        "label": "Save Summary",
                        "target_path": config.get("save_path"),
                    },
                }
            )
        ...
        nodes.append(
            {
                ...
                "data": {
                    "label": "User Query",
                    "target_path": "RAW_CONTEXT:"
                    + config.get("query", "Summarize the data."),
                },
            }
        )
        nodes.append(
            {
                ...
                "type": "memory_query",
                "data": {
                    "label": "Search Local Data",
                    "memory_collection": "chat_data",
                    "memory_top_k": 3,
                },
            }
        )
    ...
    return {"workflow_id": wf_id, "nodes": nodes, "edges": edges}
